...
import aboutImage from "../asset/image1.png";
import WhyUsSection from "./whyus.js";
import "../styles.css";
import DiversitySection from "./leadership.js";
    ...
    <div className="bg-gray-100">
      ...
      >
        <div className="text-center">
          ...
          <button className="py-3 px-6 font-medium text-white bg-blue-600 rounded-lg shadow hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600">
            Apply Now
          </button>
        </div>
      </div>
